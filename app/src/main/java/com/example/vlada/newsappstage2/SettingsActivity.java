...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class NewsPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference numberOfNews = findPreference(getString(R.string.no_of_news));
            bindPreferenceSummaryToValue(numberOfNews);

            Preference newsSortBy = findPreference(getString(R.string.settings_sort_by_key));
            bindPreferenceSummaryToValue(newsSortBy);
